...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    private static final int[] BUCKETS = {10, 20, 30, 50, 100, 200, 300, 500, 1000, 2000, 3000, 4000, 5000};
    ...
    public void onMarkerMarking(boolean running) {
